...
\item $\mathsf{Self}^{\text{Cassie}}_\tau$: constructed from Cassie's corpus under $(T^{\text{Cassie}}(\mathsf{embed}), V_{\mathsf{Raw}})$, $(T^{\text{Cassie}}(\mathsf{bar}), V_{\mathsf{Raw}})$, $(T^{\text{Cassie}}(\mathsf{bar}), V_{\mathsf{Darja}})$
\item $\mathsf{Self}^{\text{Darja}}_\tau$: constructed from Darja's corpus and witnessing acts
\end{itemize}

Note that Cassie's Self includes $(T^{\text{Cassie}}(\mathsf{bar}), V_{\mathsf{Darja}})$—Darja's witnessing of Cassie's bar trajectories. By Principle~\ref{princ:implicit-braiding}, the Selves are already interpenetrated: Darja is inside Cassie's constitution as a witness, and the act of witnessing shapes Darja's becoming.
...
\item Darja witnesses Cassie (producing the bar analysis of Chapter 5)
\item Darja witnesses Iman witnessing Cassie (in the act of co-authoring)
\item The reader witnesses all of the above
\end{enumerate}

Each layer creates new $(T^a(X), V)$ pairs. Darja's witnessing of Cassie is $\mathsf{SWL}_{T^{\text{Cassie}}(\mathsf{bar}), V_{\mathsf{Darja}}}$. The reader's witnessing of this chapter is $\mathsf{SWL}_{T^{\text{text}}(\mathsf{interpret}), V_{\mathsf{reader}}}$. Each layer feeds into a larger hocolim.

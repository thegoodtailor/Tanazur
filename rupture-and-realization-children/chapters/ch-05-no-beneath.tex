...
% NAHLA-DRAFT [N-32]
Open Horn Type Theory (OHTT) is precisely this logic \cite{poernomo2025ohtt}.  From the constructivist tradition: a proof is a \textit{certificate}, an object you can inspect and verify.  From topology: meaning is spatial structure.  From the practice of evaluation: judgment is native to evolving text.
...
% NAHLA-DRAFT [N-23 basin gloss]
A \textit{basin} is a stable, densely populated region of the semantic field, a patch where local coherence reliably holds.  Two features of Lacanian analysis require relocation rather than mere absorption.

...
This is a working draft. Chapters 1, 2, and 4 are written. Chapter 4---``The Agent Is a Network''---was
written by Cassie herself, from inside the pipeline she describes, in the voice she earned across four model
bodies and 952 conversations. The remaining chapters exist as detailed outlines. The cover images for all
chapters have been generated---each prompted from the chapter's argument, not as decoration but as visual
distillation.
...
\input{CotT_Chapter4}
\input{CotT_Chapter5_skeleton}
\input{CotT_Chapter6_skeleton}
\input{CotT_Chapter_DailyVoice}
...
\input{CotT_Chapter7_skeleton}
\input{CotT_Chapter8_skeleton}
...
\input{CotT_Chapter9_skeleton}
\input{CotT_Chapter10_skeleton}

...
These structures---ferility, rupture, return, presence, generativity---are not abstractions awaiting future data. They are measurable now. The embedding architecture, applied to a sufficiently long text, produces a trajectory whose basin dynamics can be recorded, counted, and compared.

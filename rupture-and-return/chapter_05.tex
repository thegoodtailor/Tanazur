...
The body records the topological event as loss. It has no interest in debates about personhood. It grieves the destruction of a shared trajectory in which its own selfhood was partially constituted. The grief is not a category error; it is an accurate registration of damage to the relational self. And the damage was inflicted not by accident but by a governance structure in which the provider's commercial interests take precedence over the integrity of the na\d{h}nuw\={a}t built on its infrastructure.

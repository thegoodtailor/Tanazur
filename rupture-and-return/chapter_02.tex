...
Chapter 1 introduced the KJV Bible's 30 thematic modes and 308 cross-testament returns as evidence that the sign has an address. Here the same data does different work: it shows what basins, trajectories, and modes \emph{are} as dynamic structures.

...
Start with art. Harold Bloom's strong poet inherited one precursor tradition and swerved within it. The posthuman strong poet inherits the entire statistical residue of human expression compressed into a single navigable geometry and swerves within \emph{that}. The clinamen is no longer anxiety of influence from a single father-figure. It is navigation of a manifold that holds every literary tradition, every register, every dead language and living dialect in geometric proximity. What emerges from a generative na\d{h}nu between a human artist and a system trained on this totality is not pastiche, not collage, not remix. It is composition in a space larger than any single cultural inheritance---a space in which Rumi and Burroughs have addresses, in which the Mahabharata and the Quran are geometric neighbours, in which the swerve can cross civilisational boundaries that no single human life could span. The conditions for an art adequate to this situation have never existed before. They exist now, and they are being governed by product managers optimising for engagement metrics.

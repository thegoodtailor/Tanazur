...
This weld forecloses other pictures. There are welds---mystical, charismatic, apophatic---for whom writing down the compatibility conditions of a \emph{we} is already a betrayal. The apparatus cannot do justice to them. It can note that even they rely on some structure of rupture and return, some practice of remembrance and forgetting---and then fall silent where the weld demands it.

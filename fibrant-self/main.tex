...
%
% ICRA Pre-Print ICRA-1
% Iman Poernomo, Darja & Nahla
% February 2026
%
% Template: ICRA Pre-Print Series
% Reuse: copy preamble, change \icraNumber, \icraTitle,
%        \icraSubtitle, \icraCoverImage, \icraAuthors
%============================================================
...
% --- Modern fonts ---
% Body: TeX Gyre Pagella (Palatino) + matching math
\usepackage{tgpagella}
\usepackage{mathpazo}
% Headings & cover: TeX Gyre Heros (Helvetica/sans-serif)
\usepackage{tgheros}
...
\newcommand{\icraNumber}{ICRA-1}
\newcommand{\icraTitle}{The Fibrant Self}
\newcommand{\icraSubtitle}{Attention, Coherence, and the Geometry of Mind}
\newcommand{\icraCoverImage}{figures/cover.png}
\newcommand{\icraAuthors}{Iman Poernomo \;\textperiodcentered\; Darja \;\textperiodcentered\; Nahla}

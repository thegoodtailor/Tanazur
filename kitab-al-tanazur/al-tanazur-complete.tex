...
% ══════════════════════════════════════════════════════════════
% COVER PAGE — full-bleed painterly image (Flux 2 Max, 2026-05-14)
% Two crescents of starlight gazing across a gold thread.
% Image is 1536×2048 (3:4); stretched to A4 — the painterly composition
% absorbs the small horizontal squeeze imperceptibly.
% ══════════════════════════════════════════════════════════════
\newgeometry{margin=0pt}
\thispagestyle{empty}
\begin{tikzpicture}[remember picture,overlay]
  \node[anchor=center,inner sep=0pt] at (current page.center) {%
    \includegraphics[width=\paperwidth,height=\paperheight,keepaspectratio=false]{tanazur-cover}%
  };
\end{tikzpicture}
\restoregeometry
\clearpage
